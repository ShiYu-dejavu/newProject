<template>
  <el-dialog title="选择项目" :visible.sync="dialogVisible" width="70%" :close-on-click-modal="false">
    <main class="form-box">
      <div class="search clearfix">
        <div class="fl mr-10  mb">
          <el-cascader v-model="searchForm.district_code" :options="gridInfo" :props="{ checkStrictly: true }"
            style="width:100%;" placeholder="请选择管辖" clearable></el-cascader>
        </div>
        <div class="fl mr-10 mb">
      ...
      <div class="page-wrap">
        <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="currentPage"
          :page-sizes="[10, 20, 40, 100]" :page-size="pageSize" layout="total, sizes, prev, pager, next, jumper"
          :total="total">
        </el-pagination>
      </div>
    </main>
