<template>
  <div class="reportform app-container">
    <div class="header clearfix">
      <h5 class="fl title">
        <el-button v-if="$route.query.report_code" size="small" class="el-icon-arrow-left" @click="$router.go(-1)">返回</el-button><span
          style="padding-left:20px">{{$route.query.report_code?'编辑':'新增'}}</span>举报登记<span class="reqort-code"
          v-if="$route.query.report_code">案件编号：{{$route.query.report_code}}</span>
      </h5>
    </div>
      ...
      <div class="form-box">
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="120px" class="demo-ruleForm">
          <div id="print_box" style="margin-left:30px;">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="姓名:"
                  :rules="[{ required: elect, message: '请输入名字',  trigger: 'blur' },{ min: 2, max: 5, message: '长度在 2 到 5 个字符', trigger: 'blur' } ]"
                  prop="informant_name_1">
                  <el-input v-model="ruleForm.informant_name_1"></el-input>
                </el-form-item>
              </el-col>

              <el-col :span="12">
                <el-form-item :rules="[{ required: elect, message:'请选择性别',  trigger: 'blur' }, ]" label="性别:"
                  prop="informant_sex">
            ...
            <el-row>
              <el-col>
                <el-form-item :rules="[{ required: elect, message: '请输入地址', trigger: 'blur' }, ]" label="地址:"
                  prop="informant_address">
            ...
            <el-row>
              ...
              <el-col :span="12">
                ...
                <span v-if="showInfo" class="info-dialog el-icon-info">企业主体库中不存在，是否<span class="info"
                    @click="goDialog">新增企业主体</span></span>
              </el-col>
            </el-row>
            <el-form-item label="">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="所属管辖:" prop="region_code">
                  <el-cascader v-model="ruleForm.region_code" :options="gridInfo" :props="{ checkStrictly: true }"
                    style="width:100%;" placeholder="请选择区域" clearable></el-cascader>
                </el-form-item>
              </el-col>
            ...
            <div v-if="elect">
              ...
              <div v-for="(domain,index) in ruleForm.domains" :key="domain.key" class="add-domain">
                ...
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="姓名:" :prop="'domains.' + index + '.informant_name2'"
                      :rules="[{ required: true, message: '请输入姓名', trigger: 'blur'    },{ min: 2, max: 5, message: '长度在 2 到 5 个字符', trigger: 'blur' }]">
                      <el-input v-model="domain.informant_name2"></el-input>
                    </el-form-item>
                  </el-col>

                  <el-col :span="12">
                    <el-form-item label="性别:" :prop="'domains.' + index + '.sex2'"
                  ...
                  <el-col :span="12">
                    <el-form-item label="联系电话:" :prop="'domains.' + index + '.informant_phone2'"
                  ...
                  <el-col>
                    <el-form-item label="地址:" :prop="'domains.' + index + '.informant_address2'"
          ...
          <el-form-item label="证据材料上传:" prop="proveUrlList" style="margin:20px 0 0 30px">
            <div class="upload">
              <MyUpload
                ref="myUpload"
                accept='png,jpg,jpeg'
        ...
        api.reportinfo(data)
          .then((res) => {
            if (res.data.code == 201) {
              ...
              this.ruleForm.report_type = parseInt(this.originForm.REPORT_TYPE);
